...
embeddingModel = "openface_nn4.small2.v1.t7" #deep learning model for embedding

prototxt = "model/deploy.prototxt" 
model =  "model/res10_300x300_ssd_iter_140000.caffemodel" #pre trained face recognition model
